...
def calculates_results_stats(results_dic):
    ...
    for result in results_dic.values():
        n_dogs_img += 1 if result[3] == 1 else 0
        n_notdogs_img += 1 if result[3] == 0 else 0
        n_match += 1 if result[2] == 1  else 0
        n_correct_dogs += 1 if result[3] == 1 and result[4] == 1 else 0
        n_correct_notdogs += 1 if result[3] == 0 and result[4] == 0 else 0
        n_correct_breed += 1 if result[2] == 1 and result[3] == 1 else 0
